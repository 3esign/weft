# DOMET_A2L_X1 — reproducible build

Run from the WEFT repository root with the installed Node; no added dependencies, no Python.

```
node core/weft_domet_geometry.mjs --machine a2l --wall-mm 10 \
     --out DOMET_A2L_X1_geometry.json --svg DOMET_A2L_X1_preview.svg
node weft.mjs build --geo DOMET_A2L_X1_geometry.json --machine a2l --out <a fresh folder> \
     --name DOMET_A2L_X1 --allow-experimental-bridge
```
