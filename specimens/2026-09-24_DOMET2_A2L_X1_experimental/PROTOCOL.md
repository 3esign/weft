# DOMET2_A2L_X1 — reproducible build

Run from the WEFT repository root with the installed Node; no added dependencies, no Python.

```
node core/weft_domet2_geometry.mjs --machine a2l \
     --out DOMET2_A2L_X1_geometry.json
node weft.mjs build --geo DOMET2_A2L_X1_geometry.json --machine a2l --out <a fresh folder> \
     --name DOMET2_A2L_X1 --allow-experimental-bridge
```
