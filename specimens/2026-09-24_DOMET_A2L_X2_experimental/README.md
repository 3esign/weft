# DOMET_A2L_X2 — corrected reissue

**Print `DOMET_A2L_X2.gcode.3mf` from this folder.**

Supersedes `2026-09-24_DOMET_A2L_X1_experimental`, which must not be printed.
...
`DOMET_A2L_X1.gcode.3mf` and `DOMET_A2L_X2.gcode.3mf` — model first Z and preview
...
| check | result |
|---|---|
| support gate, declared ceiling | **PASS** — 0 problems over 456,270 points / 242 layers |
| first-layer audit | **PASS** — 1 island, model Z = preview Z = 0.240 |
| second gate at the evidenced 16.2 mm | 598 findings, **0 outside the declared zones** |
...
| max Z | 57.84 mm |
| thread path | 280.7 m |
| filament | 11,923.30 mm ≈ **36.14 g** |
| weld nodes | 17,013 |
| estimated time | 5 h 04 m 27 s (kinematic estimate, not the printer's own) |
