# KUKA_A2L_X1 — KUKA — the end-condition ladder: is it the free length that kills, or the free end?

**Print `KUKA_A2L_X1.gcode.3mf` from this folder.** Machine: Bambu A2L. Layer height 0.24 mm.
...
| thread path | 122.2 m |
| estimated time | 1.13 h (kinematic, a lower bound) |
...
`KUKA_A2L_X1_plan.svg` draws the ten sectors with their rungs.
